# Graph Report - CRM-CONSTRUTORA-NOGMA  (2026-09-18)

## Corpus Check
- 619 files · ~546,618 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6405 nodes · 8830 edges · 1967 communities (271 shown, 1696 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0dc97eeb`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Documentos telas e formulário|Documentos: telas e formulário]]
- [[_COMMUNITY_Autorizados actions e telas|Autorizados: actions e telas]]
- [[_COMMUNITY_Categorias CRUD|Categorias: CRUD]]
- [[_COMMUNITY_Spec original (0309)|Spec original (03/09)]]
- [[_COMMUNITY_Documentos upload e schema|Documentos: upload e schema]]
- [[_COMMUNITY_Usuários convite e papéis|Usuários: convite e papéis]]
- [[_COMMUNITY_Eng review gstack (plano técnico)|Eng review gstack (plano técnico)]]
- [[_COMMUNITY_Design System guia e SKILL|Design System: guia e SKILL]]
- [[_COMMUNITY_Plano Fase 6 (vendasERP)|Plano Fase 6 (vendas/ERP)]]
- [[_COMMUNITY_Auditoria ultra prêmio (design)|Auditoria ultra prêmio (design)]]
- [[_COMMUNITY_TODOS e ações humanas|TODOS e ações humanas]]
- [[_COMMUNITY_Classificador Anthropic (visão)|Classificador Anthropic (visão)]]
- [[_COMMUNITY_Dependências appsweb|Dependências apps/web]]
- [[_COMMUNITY_Plano arquitetura code-first|Plano arquitetura code-first]]
- [[_COMMUNITY_Inbound WhatsApp e UAZAPI|Inbound WhatsApp e UAZAPI]]
- [[_COMMUNITY_Manual de pendências (superado)|Manual de pendências (superado)]]
- [[_COMMUNITY_CEO review gstack|CEO review gstack]]
- [[_COMMUNITY_Backup semanal cifrado|Backup semanal cifrado]]
- [[_COMMUNITY_Importar CSV de pagamentos|Importar CSV de pagamentos]]
- [[_COMMUNITY_Auditoria serviços e integrações|Auditoria serviços e integrações]]
- [[_COMMUNITY_Regras do CLAUDE.md e datas|Regras do CLAUDE.md e datas]]
- [[_COMMUNITY_Roteiro go-live|Roteiro go-live]]
- [[_COMMUNITY_Fases e filas pgmq|Fases e filas pgmq]]
- [[_COMMUNITY_Plano do banco (revisão 1209)|Plano do banco (revisão 12/09)]]
- [[_COMMUNITY_DS bundle (componentes JSX)|DS bundle (componentes JSX)]]
- [[_COMMUNITY_Auditoria diff viewer|Auditoria: diff viewer]]
- [[_COMMUNITY_Webhooks de saída|Webhooks de saída]]
- [[_COMMUNITY_Setup Supabase e plano 1|Setup Supabase e plano 1]]
- [[_COMMUNITY_Verificação do briefing 1609|Verificação do briefing 16/09]]
- [[_COMMUNITY_Handoff Fase 0|Handoff Fase 0]]
- [[_COMMUNITY_Fornecedores e planilha compartilhada|Fornecedores e planilha compartilhada]]
- [[_COMMUNITY_n8n (workflows documentados)|n8n (workflows documentados)]]
- [[_COMMUNITY_Interpretar SIMNÃO|Interpretar SIM/NÃO]]
- [[_COMMUNITY_Exportação CSVPDF (rotas)|Exportação CSV/PDF (rotas)]]
- [[_COMMUNITY_biome.json|biome.json]]
- [[_COMMUNITY_Design review gstack|Design review gstack]]
- [[_COMMUNITY_UI kit nogmaOS|UI kit nogmaOS]]
- [[_COMMUNITY_package.json raiz|package.json raiz]]
- [[_COMMUNITY_Rotas API e cron|Rotas API e cron]]
- [[_COMMUNITY_SO-FALTA-VOCE (ações humanas)|SO-FALTA-VOCE (ações humanas)]]
- [[_COMMUNITY_Ferramentas da IA (obras)|Ferramentas da IA (obras)]]
- [[_COMMUNITY_Inventário do protótipo|Inventário do protótipo]]
- [[_COMMUNITY_CI e workflows GitHub|CI e workflows GitHub]]
- [[_COMMUNITY_Auditoria de segurança|Auditoria de segurança]]
- [[_COMMUNITY_Nogma, cliente e produto|Nogma, cliente e produto]]
- [[_COMMUNITY_Relatórios PDF (templates)|Relatórios PDF (templates)]]
- [[_COMMUNITY_Assistente de IA (laço)|Assistente de IA (laço)]]
- [[_COMMUNITY_Ambientes e env vars Vercel|Ambientes e env vars Vercel]]
- [[_COMMUNITY_Auditoria infradeployCI|Auditoria infra/deploy/CI]]
- [[_COMMUNITY_Apelidos e duplicatas|Apelidos e duplicatas]]
- [[_COMMUNITY_Consumidor da fila|Consumidor da fila]]
- [[_COMMUNITY_Handoff Vercel|Handoff Vercel]]
- [[_COMMUNITY_Plano front-end premium|Plano front-end premium]]
- [[_COMMUNITY_Tutorial completo|Tutorial completo]]
- [[_COMMUNITY_Automações regras e registry|Automações: regras e registry]]
- [[_COMMUNITY_Posts (UI kit)|Posts (UI kit)]]
- [[_COMMUNITY_Perfil e preferências|Perfil e preferências]]
- [[_COMMUNITY_Duplicatas e e-mails|Duplicatas e e-mails]]
- [[_COMMUNITY_Confirmações pendentes|Confirmações pendentes]]
- [[_COMMUNITY_Engine de automações|Engine de automações]]
- [[_COMMUNITY_Embeddings e RAG|Embeddings e RAG]]
- [[_COMMUNITY_Middleware e Fase 8|Middleware e Fase 8]]
- [[_COMMUNITY_Auditoria fidelidade ao DS|Auditoria fidelidade ao DS]]
- [[_COMMUNITY_Alinhamento Cavalcanti|Alinhamento Cavalcanti]]
- [[_COMMUNITY_Auditoria backend (0809)|Auditoria backend (08/09)]]
- [[_COMMUNITY_PROJETO-STATUS|PROJETO-STATUS]]
- [[_COMMUNITY_Plano Cloudflare|Plano Cloudflare]]
- [[_COMMUNITY_Fase 18 bulk e import|Fase 18: bulk e import]]
- [[_COMMUNITY_Fase 20 a11y e StatusBanner|Fase 20: a11y e StatusBanner]]
- [[_COMMUNITY_QA report gstack|QA report gstack]]
- [[_COMMUNITY_Arquitetura (estrutura)|Arquitetura (estrutura)]]
- [[_COMMUNITY_Inventário de documentação|Inventário de documentação]]
- [[_COMMUNITY_DS formulários|DS: formulários]]
- [[_COMMUNITY_Auditoria frontinfra (0809)|Auditoria front/infra (08/09)]]
- [[_COMMUNITY_Obras tabela e página|Obras: tabela e página]]
- [[_COMMUNITY_Pendentes página e dados|Pendentes: página e dados]]
- [[_COMMUNITY_E2E Playwright|E2E Playwright]]
- [[_COMMUNITY_Runbook backup|Runbook backup]]
- [[_COMMUNITY_Runbook Vercel Pro|Runbook Vercel Pro]]
- [[_COMMUNITY_index window.NogmaDesignSystem_54b71f|index: window.NogmaDesignSystem_54b71f]]
- [[_COMMUNITY_ALINHAMENTO CAVALCANTI 16 09 configwebhooks|ALINHAMENTO CAVALCANTI 16 09: /config/webhooks]]
- [[_COMMUNITY_painel page.tsx|painel: page.tsx]]
- [[_COMMUNITY_page page.tsx|page: page.tsx]]
- [[_COMMUNITY_rate limit actions.ts|rate limit: actions.ts]]
- [[_COMMUNITY_tsconfig.base tsconfig.base.json|tsconfig.base: tsconfig.base.json]]
- [[_COMMUNITY_documentos agrupados documentos-agrupados.tsx|documentos agrupados: documentos-agrupados.tsx]]
- [[_COMMUNITY_loading loading.tsx|loading: loading.tsx]]
- [[_COMMUNITY_IconButton mobile-nav.tsx|IconButton: mobile-nav.tsx]]
- [[_COMMUNITY_tipos bus.ts|tipos: bus.ts]]
- [[_COMMUNITY_log log.ts|log: log.ts]]
- [[_COMMUNITY_fase 9 relatorios renderAtividadePdf()|fase 9 relatorios: renderAtividadePdf()]]
- [[_COMMUNITY_comandos whatsapp revisao-2026-09-11.test.ts|comandos whatsapp: revisao-2026-09-11.test.ts]]
- [[_COMMUNITY_PLANO ARQUITETURA CODE FIRST F-13 MEDIO observa|PLANO ARQUITETURA CODE FIRST: F-13 MEDIO observa]]
- [[_COMMUNITY_n8n integracao Integração n8n|n8n integracao: Integração n8n]]
- [[_COMMUNITY_fase 9 relatorios appapiexportstiporoute.|fase 9 relatorios: app/api/exports/[tipo]/route.]]
- [[_COMMUNITY_painel PainelPage()|painel: PainelPage()]]
- [[_COMMUNITY_planilha botao-imprimir.tsx|planilha: botao-imprimir.tsx]]
- [[_COMMUNITY_10 verificacao premio seguranca StatusBanner.ts|10 verificacao premio seguranca: StatusBanner.ts]]
- [[_COMMUNITY_documentos documentos.ts|documentos: documentos.ts]]
- [[_COMMUNITY_04 backend dados tabela audit_log|04 backend dados: tabela audit_log]]
- [[_COMMUNITY_04 backend dados Auditoria Back-end  Dados 202|04 backend dados: Auditoria Back-end / Dados 202]]
- [[_COMMUNITY_ROTEIRO DEMO 16 09 ROTEIRO-DEMO-16-09|ROTEIRO DEMO 16 09: ROTEIRO-DEMO-16-09.md]]
- [[_COMMUNITY_radii.card Progress tone=lime|radii.card: Progress tone="lime"]]
- [[_COMMUNITY_brand theme black.card Contraste — regras (✓ vá|brand theme black.card: Contraste — regras (✓ vá]]
- [[_COMMUNITY_configurar dominio configurar-dominio.mjs|configurar dominio: configurar-dominio.mjs]]
- [[_COMMUNITY_actions actions.ts|actions: actions.ts]]
- [[_COMMUNITY_layout layout.tsx|layout: layout.tsx]]
- [[_COMMUNITY_ESTADO RECUPERADO assertAdmin|ESTADO RECUPERADO: assertAdmin]]
- [[_COMMUNITY_fornecedor fornecedor.ts|fornecedor: fornecedor.ts]]
- [[_COMMUNITY_05 detalhes produto premium Inventario detalhes|05 detalhes produto premium: Inventario detalhes]]
- [[_COMMUNITY_command palette route.ts|command palette: route.ts]]
- [[_COMMUNITY_handlers route.ts|handlers: route.ts]]
- [[_COMMUNITY_09 inventario componentes ui app(app)_shared|09 inventario componentes ui: app/(app)/_shared/]]
- [[_COMMUNITY_e2e cleanup auth.spec.ts|e2e cleanup: auth.spec.ts]]
- [[_COMMUNITY_fase 10 emails getRecipientsByPapel|fase 10 emails: getRecipientsByPapel]]
- [[_COMMUNITY_registro DependenciasDoAssistente|registro: DependenciasDoAssistente]]
- [[_COMMUNITY_obra obra.ts|obra: obra.ts]]
- [[_COMMUNITY_pagamento pagamento.ts|pagamento: pagamento.ts]]
- [[_COMMUNITY_06 ultra maximo arquitetura escala CONFIANCA_AU|06 ultra maximo arquitetura escala: CONFIANCA_AU]]
- [[_COMMUNITY_tsconfig tsconfig.json|tsconfig: tsconfig.json]]
- [[_COMMUNITY_types F-32 packagesdbsrctypes.ts sincronizad|types: F-32 packages/db/src/types.ts sincronizad]]
- [[_COMMUNITY_briefing cavalcanti 16 09 Passo 6 Processar res|briefing cavalcanti 16 09: Passo 6 Processar res]]
- [[_COMMUNITY_PROTOTIPO PORTADO PROTOTIPO-PORTADO|PROTOTIPO PORTADO: PROTOTIPO-PORTADO.md]]
- [[_COMMUNITY_package package.json|package: package.json]]
- [[_COMMUNITY_04 backend dados extensao pg_trgm|04 backend dados: extensao pg_trgm]]
- [[_COMMUNITY_11 backend verificacao migrations indices confi|11 backend verificacao migrations indices: confi]]
- [[_COMMUNITY_fase 16 categorias 11 F-03 Unique global em cat|fase 16 categorias: 11 F-03 Unique global em cat]]
- [[_COMMUNITY_BLOCO 2 FLUXO WHATSAPP Migrations 2026090914000|BLOCO 2 FLUXO WHATSAPP: Migrations 2026090914000]]
- [[_COMMUNITY_apply migration Checklist do engenheiro de rele|apply migration: Checklist do engenheiro de rele]]
- [[_COMMUNITY_type eyebrow.card Type card Eyebrow & mono|type eyebrow.card: Type card: Eyebrow & mono]]
- [[_COMMUNITY_README system.css (componentes de arte)|README: system.css (componentes de arte)]]
- [[_COMMUNITY_03 frontend obras-table.tsx|03 frontend: obras-table.tsx]]
- [[_COMMUNITY_route route.ts|route: route.ts]]
- [[_COMMUNITY_actions actions.ts|actions: actions.ts]]
- [[_COMMUNITY_sidebar nav mobile-tabbar.tsx|sidebar nav: mobile-tabbar.tsx]]
- [[_COMMUNITY_enviar whatsapp enviar-whatsapp.ts|enviar whatsapp: enviar-whatsapp.ts]]
- [[_COMMUNITY_fase 10 emails logNotificacao|fase 10 emails: logNotificacao]]
- [[_COMMUNITY_reports reports.ts|reports: reports.ts]]
- [[_COMMUNITY_comandos comandos.ts|comandos: comandos.ts]]
- [[_COMMUNITY_fase 12 e2e Fase 12 Testes E2E com Playwright|fase 12 e2e: Fase 12 Testes E2E com Playwright]]
- [[_COMMUNITY_pos vercel pro Item 5 Vercel Pro um comando faz|pos vercel pro: Item 5 Vercel Pro um comando faz]]
- [[_COMMUNITY_feedback.card Alert|feedback.card: Alert]]
- [[_COMMUNITY_brand intersecao.card assetsintersecoes10.png|brand intersecao.card: assets/intersecoes/10.png]]
- [[_COMMUNITY_test webhook uazapi test-webhook-uazapi.mjs|test webhook uazapi: test-webhook-uazapi.mjs]]
- [[_COMMUNITY_05 ultra premio componentsdata-table.css|05 ultra premio: components/data-table.css]]
- [[_COMMUNITY_consumidor.test Handler|consumidor.test: Handler]]
- [[_COMMUNITY_fase 15 staging Passo-a-passo para ativar stagi|fase 15 staging: Passo-a-passo para ativar stagi]]
- [[_COMMUNITY_Tabs.prompt Rule Dialog is controlled, closes|Tabs.prompt: Rule: Dialog is controlled, closes ]]
- [[_COMMUNITY_color petroleum scale.card --petroleum-050 (F1|color petroleum scale.card: --petroleum-050 (#F1]]
- [[_COMMUNITY_import pagamento ImportarClient()|import pagamento: ImportarClient()]]
- [[_COMMUNITY_not found error.tsx|not found: error.tsx]]
- [[_COMMUNITY_page page.tsx|page: page.tsx]]
- [[_COMMUNITY_line acumulado line-acumulado.tsx|line acumulado: line-acumulado.tsx]]
- [[_COMMUNITY_08 infra deploy ci playwright.config.ts|08 infra deploy ci: playwright.config.ts]]
- [[_COMMUNITY_apply migrations staging 5.2 Migrations process|apply migrations staging: 5.2 Migrations process]]
- [[_COMMUNITY_checar integracoes Inventario real de producao|checar integracoes: Inventario real de producao ]]
- [[_COMMUNITY_brand isologo.card assetslogo-nogma-lime.png|brand isologo.card: assets/logo-nogma-lime.png]]
- [[_COMMUNITY_05 angulos Matriz 2x2 impacto x esforco ganho|05 angulos: Matriz 2x2 impacto x esforco: ganho ]]
- [[_COMMUNITY_transcricao transcricao.ts|transcricao: transcricao.ts]]
- [[_COMMUNITY_inventario lib apps web Threshold de auto-aprov|inventario lib apps web: Threshold de auto-aprov]]
- [[_COMMUNITY_provisionar vault Se algo der errado tabela de|provisionar vault: Se algo der errado tabela de ]]
- [[_COMMUNITY_tsconfig tsconfig.json|tsconfig: tsconfig.json]]
- [[_COMMUNITY_page GET()|page: GET()]]
- [[_COMMUNITY_route route.ts|route: route.ts]]
- [[_COMMUNITY_busca busca.ts|busca: busca.ts]]
- [[_COMMUNITY_04 backend dados withActor|04 backend dados: withActor]]
- [[_COMMUNITY_next.config next.config.ts|next.config: next.config.ts]]
- [[_COMMUNITY_fase 17 dashboard KPIs com historia parcial sem|fase 17 dashboard: KPIs com historia parcial sem]]
- [[_COMMUNITY_color lime status.card Alert variants success|color lime status.card: Alert variants: success ]]
- [[_COMMUNITY_brand lime motif.card Lime full-stop  key numb|brand lime motif.card: Lime full-stop / key numb]]
- [[_COMMUNITY_AGENTS appswebAGENTS|AGENTS: apps/web/AGENTS.md]]
- [[_COMMUNITY_ESTADO RECUPERADO app(app)pendentespage.tsx|ESTADO RECUPERADO: app/(app)/pendentes/page.tsx]]
- [[_COMMUNITY_bar serie mensal bar-serie-mensal.tsx|bar serie mensal: bar-serie-mensal.tsx]]
- [[_COMMUNITY_donut categoria donut-categoria.tsx|donut categoria: donut-categoria.tsx]]
- [[_COMMUNITY_layout layout.tsx|layout: layout.tsx]]
- [[_COMMUNITY_fornecedor FornecedorCreateSchema|fornecedor: FornecedorCreateSchema]]
- [[_COMMUNITY_2026 09 12 eng review libsecurityflash-secret|2026 09 12 eng review: lib/security/flash-secret]]
- [[_COMMUNITY_N8N COMPLETO F-03 ALTO WF1 do n8n emite null on|N8N COMPLETO: F-03 ALTO WF1 do n8n emite null on]]
- [[_COMMUNITY_pagamentos filters pagamentos-filters.tsx|pagamentos filters: pagamentos-filters.tsx]]
- [[_COMMUNITY_05 ultra premio FilePreview|05 ultra premio: FilePreview]]
- [[_COMMUNITY_04 backend dados parseValorBR()|04 backend dados: parseValorBR()]]
- [[_COMMUNITY_04 backend dados gasto_por_categoria|04 backend dados: gasto_por_categoria]]
- [[_COMMUNITY_04 backend dados increment_webhook_execution|04 backend dados: increment_webhook_execution]]
- [[_COMMUNITY_04 backend dados tabela confirmacoes_pendentes|04 backend dados: tabela confirmacoes_pendentes]]
- [[_COMMUNITY_05 ultra premio G-18 Money Cnpj Cpf formatters|05 ultra premio: G-18 Money Cnpj Cpf formatters ]]
...
- [[_COMMUNITY_Tag.d Tag.d.ts|Tag.d: Tag.d.ts]]
- [[_COMMUNITY_Dialog.d Dialog.d.ts|Dialog.d: Dialog.d.ts]]
- [[_COMMUNITY_Progress.d Progress.d.ts|Progress.d: Progress.d.ts]]
- [[_COMMUNITY_Tooltip.d Tooltip.d.ts|Tooltip.d: Tooltip.d.ts]]
- [[_COMMUNITY_Checkbox.d Checkbox.d.ts|Checkbox.d: Checkbox.d.ts]]
- [[_COMMUNITY_Input.d Input.d.ts|Input.d: Input.d.ts]]
- [[_COMMUNITY_Switch.d Switch.d.ts|Switch.d: Switch.d.ts]]
- [[_COMMUNITY_Textarea.d Textarea.d.ts|Textarea.d: Textarea.d.ts]]
- [[_COMMUNITY_vitest.config vitest.config.ts|vitest.config: vitest.config.ts]]
...
5. `TopBar()` - 46 edges
6. `logger` - 46 edges
7. `estadoDoFormulario` - 42 edges
8. `Button()` - 41 edges
9. `Json` - 41 edges
10. `voltarComErro()` - 39 edges
...
- `Integração com OneDrive` --conceptually_related_to--> `Supabase (PostgreSQL 17.6)`  [AMBIGUOUS]
  ESTRUTURA DO PROJETO/apresentacao-projeto-cavalcanti.pdf → CLAUDE.md
- `Contagens de referência dentro do backup` --semantically_similar_to--> `Verifique antes de afirmar`  [INFERRED] [semantically similar]
  .github/workflows/backup-banco.yml → CLAUDE.md
- `Apresentação do projeto Gestor de Obras (PDF, 7 páginas)` --references--> `Cavalcanti Construções (cliente final)`  [EXTRACTED]
  ESTRUTURA DO PROJETO/apresentacao-projeto-cavalcanti.pdf → CLAUDE.md
- `Planilha do cliente (tempo real, exportação, link compartilhável)` --conceptually_related_to--> `docs/PROTOTIPO-PORTADO.md (o que veio do protótipo)`  [INFERRED]
  ESTRUTURA DO PROJETO/apresentacao-projeto-cavalcanti.pdf → CLAUDE.md

## Import Cycles
- 2-file cycle: `apps/web/lib/ia/anthropic-modelo.ts -> apps/web/lib/ia/modelo-ferramentas.ts -> apps/web/lib/ia/anthropic-modelo.ts`
- 2-file cycle: `apps/web/lib/ia/modelo-ferramentas.ts -> apps/web/lib/ia/openai-modelo.ts -> apps/web/lib/ia/modelo-ferramentas.ts`
...
- 2-file cycle: `apps/web/lib/ia/classifier.ts -> apps/web/lib/ia/openai-classifier.ts -> apps/web/lib/ia/classifier.ts`
- 3-file cycle: `apps/web/lib/ia/anthropic-classifier.ts -> apps/web/lib/ia/classificador-comum.ts -> apps/web/lib/ia/classifier.ts -> apps/web/lib/ia/anthropic-classifier.ts`
- 3-file cycle: `apps/web/lib/ia/classificador-comum.ts -> apps/web/lib/ia/classifier.ts -> apps/web/lib/ia/openai-classifier.ts -> apps/web/lib/ia/classificador-comum.ts`
- 4-file cycle: `apps/web/lib/ia/classificador-comum.ts -> apps/web/lib/ia/classifier.ts -> apps/web/lib/ia/openai-classifier.ts -> apps/web/lib/ia/openai.ts -> apps/web/lib/ia/classificador-comum.ts`
...
- **Fase 3 — filas pgmq agendadas por pg_cron/pg_net** — claude_filas_pgmq, claude_pg_cron_pg_net, claude_api_queue_consume, claude_fila_whatsapp_flag, claude_middleware_rotas_publicas [EXTRACTED 1.00]
- **As seis telas do protótipo aprovado pelo cliente** — estrutura_do_projeto_arquitetura_tela_fornecedores, estrutura_do_projeto_arquitetura_tela_gestao_de_obras, estrutura_do_projeto_arquitetura_tela_pendencias, estrutura_do_projeto_arquitetura_tela_documentos, estrutura_do_projeto_arquitetura_tela_painel, estrutura_do_projeto_arquitetura_tela_fila_whatsapp [EXTRACTED 1.00]
- **Nogma brand palette (petroleum · lime · black · gray · white)** — nogma_design_system_guidelines_color_primary_card_verde_petroleo_0c4651, nogma_design_system_guidelines_color_primary_card_lime_ccff00, nogma_design_system_guidelines_color_neutral_card_preto_000000, nogma_design_system_guidelines_color_neutral_card_cinza_a1a1a1, nogma_design_system_guidelines_color_neutral_card_branco_ffffff [EXTRACTED 1.00]
- **Form control family sharing label/hint/error chrome and 44px height** — nogma_design_system_components_forms_forms_card_input, nogma_design_system_components_forms_forms_card_textarea, nogma_design_system_components_forms_forms_card_select, nogma_design_system_components_forms_forms_card_checkbox, nogma_design_system_components_forms_forms_card_switch, nogma_design_system_components_forms_forms_card_radio_group, nogma_design_system_components_forms_forms_prompt_label_hint_error_chrome, nogma_design_system_components_forms_forms_prompt_control_height_44px [EXTRACTED 1.00]
- **Lime is accent only — highlighter, dots, key numbers, buttons; never long text** — nogma_design_system_guidelines_color_primary_card_lime_never_long_text, nogma_design_system_guidelines_brand_lime_motif_card_lime_punctual_highlight, nogma_design_system_guidelines_brand_theme_black_card_on_black, nogma_design_system_guidelines_brand_lime_motif_card_mark_highlighter, nogma_design_system_components_feedback_feedback_card_progress_tone_lime, nogma_design_system_guidelines_brand_theme_black_card_btn_lime [INFERRED 0.85]
- **Carrossel diagnostico (deck de referencia 01-07)** — nogma_design_system_ui_kits_posts_01_capa, nogma_design_system_ui_kits_posts_02_problema, nogma_design_system_ui_kits_posts_03_dado, nogma_design_system_ui_kits_posts_04_metodo, nogma_design_system_ui_kits_posts_05_angulos, nogma_design_system_ui_kits_posts_06_ordem, nogma_design_system_ui_kits_posts_07_cta [EXTRACTED 1.00]
- **Fluxo inbound do WhatsApp ponta a ponta** — apps_web_app_api_webhooks_uazapi_route, apps_web_lib_services_inbound_whatsapp_processarinbound, apps_web_app__app__config_autorizados, apps_web_lib_ia_transcricao, apps_web_lib_whatsapp_resposta_interpretarresposta, apps_web_lib_services_confirmacoes, apps_web_lib_ia_anthropic_classifier, apps_web_lib_services_uazapi [EXTRACTED 1.00]
- **Caminho happy path de go-live (2026-09-08)** — docs_manual_pendencias_resend_emails_reais, docs_manual_pendencias_anthropic_classifier, docs_manual_pendencias_uazapi_instancia_whatsapp, docs_manual_pendencias_supabase_staging, docs_manual_pendencias_github_workflow_e2e_secrets, docs_manual_pendencias_convidar_equipe_cavalcanti [EXTRACTED 1.00]
- **Os 7 workflows n8n documentados** — docs_n8n_completo_wf1_uazapi_crm_bridge_hmac, docs_n8n_completo_wf2_slack_notif_pagamento_maior_5k, docs_n8n_completo_wf3_google_sheets_log_pagamentos, docs_n8n_completo_wf4_drive_sync_documentos, docs_n8n_completo_wf5_whatsapp_reminder_nfs_sem_comprovante_7d, docs_n8n_completo_wf6_weekly_digest_email_sexta_18h, docs_n8n_completo_wf7_bot_confirmacao_whatsapp [EXTRACTED 1.00]
- **Fases 0-6 do plano de arquitetura code-first** — docs_plano_arquitetura_code_first_fase_0_decidida_2026_09_10, docs_plano_arquitetura_code_first_fase_1_blindar_entrega_16_09, docs_plano_arquitetura_code_first_fase_2_nucleo_de_eventos_e_automacoes, docs_plano_arquitetura_code_first_fase_3_filas_sem_sair_da_vercel, docs_plano_arquitetura_code_first_fase_4_ia_e_rag, docs_plano_arquitetura_code_first_fase_5_operacao_e_confianca, docs_plano_arquitetura_code_first_fase_6_dominio [EXTRACTED 1.00]
- **Fila no Postgres: pgmq + pg_cron + pg_net** — docs_plano_arquitetura_code_first_extensao_pgmq_1_5_1, docs_plano_arquitetura_code_first_extensao_pg_cron_1_6_4, docs_plano_arquitetura_code_first_extensao_pg_net_0_20_4, docs_plano_arquitetura_code_first_rota_api_queue_consume [EXTRACTED 1.00]
- **Plano de migração para Workers (se decidido)** — docs_plano_cloudflare_fase_a_provar_que_roda, docs_plano_cloudflare_fase_b_paridade, docs_plano_cloudflare_fase_c_virada [EXTRACTED 1.00]
- **Marcos M0-M5 da Fase 6 (vendas)** — docs_plano_fase_6_marco_m0_pre_requisitos, docs_plano_fase_6_marco_m1_adaptador_e_espelho_de_cadastro, docs_plano_fase_6_marco_m2_agenda_e_ocorrencias_no_whatsapp, docs_plano_fase_6_marco_m3_inadimplencia_e_carteira, docs_plano_fase_6_marco_m4_escrita_controlada_no_erp, docs_plano_fase_6_marco_m5_leads_de_entrada [EXTRACTED 1.00]
- **Tabelas do espelho do ERP** — docs_plano_fase_6_tabela_erp_funcionarios, docs_plano_fase_6_tabela_erp_clientes, docs_plano_fase_6_tabela_erp_agendamentos, docs_plano_fase_6_tabela_erp_ocorrencias, docs_plano_fase_6_tabela_erp_titulos, docs_plano_fase_6_tabela_sync_runs [EXTRACTED 1.00]
- **Sequência dos 7 passos da demo de 16/09** — docs_roteiro_demo_16_09_demo_1_painel_painel, docs_roteiro_demo_16_09_demo_2_obra_obras_garibaldi, docs_roteiro_demo_16_09_demo_3_whatsapp_fluxo_contratado, docs_roteiro_demo_16_09_demo_4_pendencias_pendentes_semaforo, docs_roteiro_demo_16_09_demo_5_planilha_compartilhavel, docs_roteiro_demo_16_09_demo_6_relatorio_do_fornecedor_relatorios, docs_roteiro_demo_16_09_demo_7_bot_responde_perguntas_resumo_pendencias_quanto_gastei [EXTRACTED 1.00]
- **Sequência do go-live: dados → WhatsApp → automações** — docs_roteiro_go_live_parte_1_popular_o_banco, docs_roteiro_go_live_parte_2_whatsapp_uazapi, docs_roteiro_go_live_parte_3_ligar_as_automacoes [EXTRACTED 1.00]
- **Passos do restore de teste** — docs_runbook_backup_restore_passo_2_aplicar_migrations_apply_migration_mjs, docs_runbook_backup_restore_passo_3_pg_restore_data_only_disable_triggers, docs_runbook_backup_restore_passo_4_conferir_contagens_10_8_80_453500, docs_runbook_backup_registro_de_restores_tabela [EXTRACTED 1.00]
- **Vercel Pro → gru1 → repo privado** — docs_runbook_vercel_pro_1_upgrade_para_vercel_pro, docs_runbook_vercel_pro_2_regiao_das_funcoes_gru1, docs_runbook_vercel_pro_3_repositorio_privado [EXTRACTED 1.00]
- **Os 11 itens de ação humana, na ordem** — docs_so_falta_voce_item_1_telefones_reais_dos_fornecedores, docs_so_falta_voce_item_2_credenciais_e_redeploy_7_variaveis_em_pares, docs_so_falta_voce_item_3_webhook_da_uazapi_e_equipe_autorizada, docs_so_falta_voce_item_4_mergear_pr_22_e_limpezas, docs_so_falta_voce_item_5_vercel_pro_um_comando_faz_o_resto, docs_so_falta_voce_item_6_backup_restore_de_teste_frase_pitr, docs_so_falta_voce_item_7_dominio_proprio_e_cloudflare, docs_so_falta_voce_item_8_indexar_a_base_de_conhecimento, docs_so_falta_voce_item_9_ligar_as_automacoes_com_cuidado, docs_so_falta_voce_item_10_depois_de_16_09_pr_7_e_fila_whatsapp, docs_so_falta_voce_item_11_decisao_fase_6_vendas [EXTRACTED 1.00]
- **As 3 auditorias paralelas de 2026-09-08 consolidadas** — docs_audit_2026_09_08_audit_security, docs_audit_2026_09_08_audit_backend, docs_audit_2026_09_08_audit_frontend_infra, docs_audit_audit_consolidado [EXTRACTED 1.00]
- **Elos do fluxo WhatsApp ponta-a-ponta (auditoria 02)** — docs_audit_2026_09_09_opus5_02_servicos_integracoes_integracao_uazapi_inbound_rota_pronta_sem_provider, docs_audit_2026_09_09_opus5_02_servicos_integracoes_integracao_anthropic_classifier_nao_implementado, docs_audit_2026_09_09_opus5_02_servicos_integracoes_integracao_uazapi_outbound_nao_implementado, docs_audit_2026_09_09_opus5_02_servicos_integracoes_integracao_n8n_nao_provisionado, docs_audit_2026_09_09_opus5_02_servicos_integracoes_elo_faltante_o_crm_nunca_responde_ao_remetente_whatsapp [EXTRACTED 1.00]
- **Pendencia -> pagamento (confirmarPendencia)** — docs_audit_2026_09_09_opus5_04_backend_dados_f_04_confirmacoes_pendentes_duplicadas_para_a_mesma_mensagem, docs_audit_2026_09_09_opus5_04_backend_dados_f_08_rejeitarpendencia_sem_auth_e_idor, docs_audit_2026_09_09_opus5_04_backend_dados_f_12_confirmarpendencia_3_mutacoes_nao_atomicas, docs_audit_2026_09_09_opus5_04_backend_dados_migration_g_confirmar_pendencia_atomic_20260909100600, db_rpc_confirmar_pendencia_atomic [EXTRACTED 1.00]
- **Caminho da foto: contrato manda a foto -> IA extrai -> documento** — docs_gstack_2026_09_12_ceo_review_g4_a_foto_nunca_chega_ao_modelo_so_a_legenda, docs_gstack_2026_09_12_ceo_review_g5_midia_confirmada_nao_vira_documentos, docs_gstack_2026_09_12_ceo_review_d3_foto_entra_no_prompt_do_claude, docs_gstack_2026_09_12_ceo_review_d6_midia_confirmada_vira_documentos, apps_web_lib_services_inbound_whatsapp_materializarmidia [EXTRACTED 1.00]
- **Fila pgmq com FILA_WHATSAPP=true** — docs_gstack_2026_09_12_eng_review_a2_throughput_de_1_msg_min_com_fila_whatsapp, docs_gstack_2026_09_12_eng_review_d7_fila_whatsapp_corrigir_throughput_antes, docs_gstack_2026_09_12_eng_review_task_t3_route_test_ts_e_laco_de_drenagem, db_rpc_fila_acordar_consumidor, apps_web_app_api_queue_consume_route [EXTRACTED 1.00]
- **Fluxo de merge de fornecedores** — apps_web_lib_services_detect_duplicates_detectduplicatefornecedores, apps_web_lib_services_merge_fornecedores_mergefornecedores, supabase_table_fornecedor_apelidos, supabase_table_fornecedores, supabase_table_pagamentos, supabase_table_documentos [EXTRACTED 1.00]
...
## Communities (1967 total, 1696 thin omitted)

### Community 0 - "Documentos: telas e formulário"
Cohesion: 0.07
Nodes (48): DocumentoForm(), DocumentosTable(), Agrupamento, AGRUPAR_OPTIONS, DocumentosToolbar(), Option, Visao, VISAO_OPTIONS (+40 more)

### Community 1 - "Autorizados: actions e telas"
Cohesion: 0.07
Nodes (39): GruposPage(), metadata, EditarAutorizadoPage(), metadata, metadata, NovoAutorizadoPage(), EditarCategoriaPage(), metadata (+31 more)

### Community 2 - "Categorias: CRUD"
Cohesion: 0.20
Nodes (10): lerArgumentos(), Json, supabase(), vercel(), api(), rest(), valorDaNota(), apagarDoStorage() (+2 more)

### Community 4 - "Documentos: upload e schema"
Cohesion: 0.15
Nodes (16): AnexoTipo, categoriaDaPasta(), normalizarNome(), REGRAS, tipoDoNome(), TIPOS, Classifier, ClassifierInput (+8 more)

### Community 5 - "Usuários: convite e papéis"
Cohesion: 0.10
Nodes (41): AlterarPapelSchema, alterarPapelUsuario(), arquivarUsuario(), assertAdmin(), ConvidarSchema, convidarUsuario(), PAPEIS, reenviarConvite() (+33 more)

### Community 6 - "Eng review gstack (plano técnico)"
Cohesion: 0.06
Nodes (33): 0.1 O que já existe e resolve (ou quase) cada subproblema, 0.2 Mínimo de mudanças que atinge o objetivo, 0.3 Complexity check, 0.4 Search check (WebSearch, 8 buscas; Aside indisponível), 0.5 Completeness check, 0.6 Distribution check, 0.7 Cross-ref com pendências (SO-FALTA-VOCE.md), 0. Step 0 — Scope Challenge (+25 more)

### Community 7 - "Design System: guia e SKILL"
Cohesion: 0.11
Nodes (23): Revisão de front-end 2026-09-12 (PR #20), Button (variants primary/solid/secondary/ghost/danger; sizes 36/44/52), Card de demonstração Buttons (@dsCard, React via unpkg + babel), IconButton (icon-only, label acessível obrigatório, round), Card de demonstração Data display (@dsCard), Avatar (iniciais em petróleo com texto lime, status), Badge (neutral/petroleum/lime/solid/status, dot), Card (interactive, flat, accent) (+15 more)

### Community 8 - "Plano Fase 6 (vendas/ERP)"
Cohesion: 0.10
Nodes (19): 1. O fato que muda o plano, 2. Três caminhos, e o recomendado, 3. Princípios que valem em qualquer caminho, 4.1 — Espelho do ERP (marcos M1–M4), 4.2 — A ponte obra ↔ empreendimento (marcos M3+), 4.3 — Só no caminho C (marco M5), 4. Modelo de dados, 5. Marcos (+11 more)

### Community 9 - "Auditoria ultra prêmio (design)"
Cohesion: 0.04
...
Cohesion: 0.13
Nodes (24): ConfirmacaoPendente, MensagemWhats, PendenteItem, DadosExtraidos, DadosExtraidosSchema, DadosLancaveis, lerDadosExtraidos(), temDadosParaLancar() (+16 more)

### Community 12 - "Dependências apps/web"
Cohesion: 0.04
Nodes (44): dependencies, @anthropic-ai/sdk, @hcaptcha/react-hcaptcha, lucide-react, mammoth, motion, next, @nogma/db (+36 more)

### Community 13 - "Plano arquitetura code-first"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (45): assertAdmin(), enviarMensagemDeTeste(), enviarWhatsapp(), mascarar(), enviarWhatsapp(), log, processarMensagemRecebida(), Registro (+37 more)

### Community 15 - "Manual de pendências (superado)"
Cohesion: 0.05
Nodes (38): 10. GitHub — Auditar colaboradores admin, 11. Rotacionar DB password Supabase, 12. Sentry OU Vercel Analytics — Error tracking, 13. Rate limiting nos endpoints públicos, 14. Domínio custom (`crm.cavalcanti.com.br`), 15. Supabase Branching (staging por PR), 16. Monitoring Grafana / DataDog, 17. LGPD compliance completo (+30 more)

### Community 16 - "CEO review gstack"
Cohesion: 0.06
Nodes (33): 0A. Premissa, 0B. Alavancagem do que já existe, 0C-bis. Alternativas de implementação, 0C. Estado-sonho (12 meses), 0D. Análise do modo, 0F. Modo, A frase que resume a revisão, Accepted Scope (entra no plano) (+25 more)

### Community 18 - "Importar CSV de pagamentos"
Cohesion: 0.10
Nodes (24): assertAdmin(), commitImportCsv(), previewImportCsv(), formatBRL(), formatDataBR(), ImportarClient(), Phase, PreviewRowCells() (+16 more)

### Community 19 - "Auditoria serviços e integrações"
Cohesion: 0.07
Nodes (26): 1. Mapa de integrações, 2. Fluxo ponta-a-ponta (onde cada elo está quebrado), 3. Findings numerados, 4.1 O que o usuário precisa fazer FORA do código (painéis, contas, chaves), 4.2 O que é código (nesta ordem), 4. "O que falta conectar" — checklist acionável, 5. Tabela final priorizada, Auditoria 02 — Camada de Serviços e Conexões Externas (+18 more)

### Community 20 - "Regras do CLAUDE.md e datas"
Cohesion: 0.09
Nodes (25): Site usa data-theme="black", /assets/css/nogma-tokens.css + site.css, Schema.org Organization (Nogma, Gravataí RS), Plataforma de atendimento por WhatsApp (painel único), Site institucional nogmacorp.com.br (HTML), Três etapas: diagnóstico, implantação, operação contínua, Cavalcanti Construções (cliente final), Fluxo por WhatsApp (núcleo do contrato) (+17 more)

### Community 21 - "Roteiro go-live"
Cohesion: 0.07
Nodes (29): 1.1 — Rodar o SQL de categorias, obras e fornecedores, 1.2 — Importar os 80 pagamentos, 2.1 — Obter as credenciais, 2.2 — Cadastrar na Vercel, 2.2b — Conferir o que falta, sem abrir o painel, 2.3 — Redeployar (o passo que todo mundo esquece), 2.3b — As outras duas chaves (IA e transcrição), 2.4 — Apontar o webhook da UAZAPI para o CRM (+21 more)

### Community 23 - "Plano do banco (revisão 12/09)"
Cohesion: 0.25
...
Cohesion: 0.07
Nodes (39): ACAO_VARIANT, AuditLogDetailPage(), formatDateTime(), MetaCard(), metadata, renderValue(), ACAO_VARIANT, agruparPorDia() (+31 more)

### Community 26 - "Webhooks de saída"
Cohesion: 0.10
Nodes (22): Avatar(), AvatarProps, AvatarSize, initials(), BadgeProps, ButtonProps, ButtonSize, ButtonVariant (+14 more)

### Community 27 - "Setup Supabase e plano 1"
Cohesion: 0.06
Nodes (34): Convenções deste plano, Encerramento do Plano #1, Fase 0 — Kickoff e repositório, Fase 1 — Design System (Nogma tokens + shadcn + 3 temas), Fase 2 — Autenticação Supabase e perfis, Fase 3 — Schema Postgres inicial + RLS, Notas para próximos planos, Plano #1 — Fundações (Fases 0-3) Implementation Plan (+26 more)

### Community 28 - "Verificação do briefing 16/09"
Cohesion: 0.17
Nodes (11): 0. Onde cada peça mora (e por que "não achei no código" ≠ "não foi pensado"), 1. Interface e ajustes — ✅ 7/7 COMPLETOS, 2. Dados e organização — ⚠️ 4/6, 3. Pendências — ❌ 1/3, 4. Fluxo principal via WhatsApp — ⚠️ PROJETADO, NÃO LIGADO (e falta 1 elo real), 5. Segurança — pendências que bloqueiam produção, 6. Infraestrutura e processo — ação sua, não código, Falta construir (não existe em lugar nenhum) (+3 more)

### Community 29 - "Handoff Fase 0"
Cohesion: 0.04
...
Cohesion: 0.07
Nodes (43): GET(), Resultado, VAZIO, DELETE(), DiarioDaObra(), PastasDaObra(), UltimasFotos(), Endereco (+35 more)
...
Cohesion: 0.13
Nodes (17): carregarHabilitadas(), EstadoRegra, executarAutomacoes(), jaAgiuHoje(), LinhaLog, log, OpcoesExecucao, registrar() (+9 more)

### Community 33 - "Exportação CSV/PDF (rotas)"
Cohesion: 0.06
Nodes (62): contentDisposition(), csvToArrayBuffer(), dateSchema, dateStamp(), GET(), pdfToArrayBuffer(), schemas, slugify() (+54 more)

### Community 34 - "biome.json"
Cohesion: 0.07
Nodes (28): files, ignore, ignoreUnknown, formatter, enabled, indentStyle, indentWidth, lineWidth (+20 more)

### Community 35 - "Design review gstack"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (17): banco(), Client, ctx(), banco(), banco(), assistente, baixarMidia, classifyAndPersist (+9 more)
...
Cohesion: 0.09
Nodes (25): FERRAMENTAS_DE_ACAO, agregarPorCategoria(), Data, EscolhaDeObra, escolherObra(), FERRAMENTAS_DE_OBRA, FiltroPagamentos, gastoPorObra (+17 more)

### Community 41 - "Inventário do protótipo"
Cohesion: 0.07
Nodes (27): 1.1 Obras / Projetos — `src/data/projects.js` (10 obras, todas `status: "ativa"`), 1.2 Fornecedores — `src/data/suppliers.js` (8), 1.3 Pagamentos — `src/data/payments.js` (80 registros), 1.4 Categorias de despesa — exaustivo, 1.5 Mensagens WhatsApp — `src/data/whatsappMessages.js` (15 mensagens), 1.6 Outros dados reais, 1. DADOS REAIS DO CLIENTE, 2.1 `/` — Dashboard — TopBar: "Painel" / "Visao geral de todas as obras" (+19 more)

### Community 42 - "CI e workflows GitHub"
Cohesion: 0.05
Nodes (41): Agenda: domingo 03:00 UTC, retenção 90 dias, Secret BACKUP_DB_URL (pooler em modo sessão), Secret BACKUP_PASSPHRASE, Cifra AES-256-CBC com pbkdf2 (openssl enc), Contagens de referência dentro do backup, Instalar pg_dump 17 via PGDG, Schemas: public obrigatório; auth e storage melhor esforço; pgmq, vault, cron fora, Validar o dump com pg_restore --list (≥ 5 TABLE DATA) (+33 more)

### Community 44 - "Auditoria de segurança"
Cohesion: 0.13
Nodes (14): Auditoria de Segurança — 2026-09-08, Findings, 🟠 HIGH-001: Webhook secret gerado com PRNG não-criptográfico (`Math.random`), 🟠 HIGH-002: Middleware deixa `/api/exports/` completamente público (sem auth server-side), 🟢 INFO-001: `.gitignore` não cobre `.auth/` explicitamente na raiz, 🟢 INFO-002: hCaptcha é condicional por env — login sem CAPTCHA possível em staging, 🟢 INFO-003: `anon` role tem SELECT em todas as tabelas públicas, 🟢 INFO-004: Erros de DB parcialmente expostos nas respostas de erro (+6 more)

### Community 45 - "Nogma, cliente e produto"
Cohesion: 0.22
Nodes (6): Contato, CRM Nogma — Gestor de Obras, Estrutura, Operação em produção, Requisitos, Setup local

### Community 46 - "Relatórios PDF (templates)"
Cohesion: 0.06
...
Cohesion: 0.12
Nodes (17): assistenteDisponivel(), ChamadaDeFerramenta, Client, extrairCitacoes(), log, PerguntaAoAssistente, perguntar(), registrar() (+9 more)

### Community 49 - "Auditoria infra/deploy/CI"
Cohesion: 0.33
Nodes (5): 1. Painel de prontidão operacional, 4. Riscos que não são findings, mas merecem registro, 6. Tabela final priorizada, 7. Comandos executados nesta auditoria, Auditoria 08 — Infraestrutura, Deploy, CI/CD e Prontidão Operacional

### Community 50 - "Apelidos e duplicatas"
Cohesion: 0.20
Nodes (9): Apelidos (`/fornecedores/[id]#apelidos`), Auto-detect Duplicatas (`/fornecedores/duplicatas`), Extensões futuras (Fase 19.x), Fase 19 — Apelidos + Auto-detect Duplicatas, Impacto no classifier IA (Fase 8), Merge (fusão), Rollback, Segurança (+1 more)

### Community 51 - "Consumidor da fila"
Cohesion: 0.08
Nodes (25): Client, consumirFila(), Handler, log, ResultadoLote, Client, EstadoFake, MsgFake (+17 more)

### Community 52 - "Handoff Vercel"
Cohesion: 0.20
Nodes (9): Passo 0: Repositório GitHub (pré-requisito), Passo 1: Importar projeto, Passo 2: Variáveis de ambiente, Passo 3: Domain, Passo 4: Deploy, Passo 5: Proteger main (recomendado), Referências, Setup Vercel (uma vez) (+1 more)

### Community 53 - "Plano front-end premium"
Cohesion: 0.29
Nodes (6): Bugs que impedem uso (prioridade máxima), Como conferir, O que foi encontrado, O que **não** mudou de propósito, Plano de front-end premium — revisão de 2026-09-12, Qualidade percebida

### Community 54 - "Tutorial completo"
Cohesion: 0.04
...
Cohesion: 0.11
Nodes (22): GET(), log, POST(), processar(), conciliarPendentes(), Client, DepsExtracao, depsPadrao() (+14 more)

### Community 59 - "Confirmações pendentes"
Cohesion: 0.15
Nodes (20): obraRecente(), AnexoTipo, arquivarDocumentoDeObra(), Client, DepsArquivar, depsPadrao, ligarMensagem(), log (+12 more)
...
Cohesion: 0.08
Nodes (23): APLICAR, cabecalhos, casamentos, categoriasNovas, catPorChave, chavesExistentes, csv, fornecedoresNovos (+15 more)

### Community 62 - "Middleware e Fase 8"
Cohesion: 0.17
Nodes (11): Checklist final Fase 8 "completa", Fase 8 — Integração WhatsApp (UAZAPI) + IA classifier, O que já existe (pronto pra usar), Passo 1 — Provisionar UAZAPI, Passo 2 — Escolher provider IA, Passo 3 — Implementar `AnthropicClassifier`, Passo 4 — Download + upload de mídia pro Storage, Passo 5 — Enviar resposta de confirmação via WhatsApp (+3 more)

### Community 63 - "Auditoria fidelidade ao DS"
Cohesion: 0.09
Nodes (22): 10. Sombras petroleum-tinted quase não usadas; sombras pretas genéricas no lugar, 11. Eyebrow com tracking fora do token, 12. Tracking de heading fora do token, 13. Título da topbar em lime no tema `dark` (petróleo) — deveria ser branco, 14. `::selection` da marca sobrescrito, 15. Gradiente onde o DS proíbe, 16. Branco hardcoded em vez de `var(--white)` / tokens de escopo, 17. Dois sistemas de gutter concorrentes (+14 more)

### Community 65 - "Auditoria backend (08/09)"
Cohesion: 0.05
Nodes (42): 1 — Server Actions, 2 — Services, 3 — API Routes, 4 — Data Layer, 5 — Error Handling, 6 — Resilience, 7 — Test Coverage Gaps (documentação — não requer implementação), Audit Backend — CRM Nogma-Cavalcanti (+34 more)

### Community 66 - "PROJETO-STATUS"
Cohesion: 0.12
Nodes (16): Como retomar, Contatos, Design System, Documentação, Estado do toolchain (verificado), Fase 1 — pronto pra começar, 🅱️ GitHub — 100% pronto ✅, Monorepo (+8 more)

### Community 67 - "Plano Cloudflare"
Cohesion: 0.14
Nodes (13): 1. O fato que muda o pedido, 2. O que a migração realmente seria, 3. A armadilha do Hyperdrive, 4. O que quebra na migração, e o que precisa ser feito, 5. A pergunta que decide, 6. O plano, se a decisão for migrar, Fase A — Provar que roda (2 dias), Fase B — Paridade (3 a 4 dias) (+5 more)

### Community 68 - "Fase 18: bulk e import"
Cohesion: 0.25
Nodes (7): Bulk archive obras (`/obras`), CSV Import (`/config/importar`), Extensões futuras (Fase 18.x), Fase 18 — Bulk Operations, Rollback, Segurança, Testar

### Community 70 - "QA report gstack"
Cohesion: 0.08
Nodes (25): Achados de ambiente (não são bugs do app), Before/After, Completion status: DONE_WITH_CONCERNS, Console Health, Decisões (auto-escolhidas, sessão spawned), Deferred (prontos para virar item de TODOS.md), Fixes Applied, Health Score: 93 → 97 /100 (+17 more)

### Community 72 - "Inventário de documentação"
Cohesion: 0.07
Nodes (28): 🔴 BLOQUEADORES, Cross-document observations worth flagging, 🟠 CRÍTICOS (6 items), docs/audit/ (4 files), docs/operacao/ (18 files), docs/superpowers/ (3 files — not in the original brief), Documentation Inventory — CRM-CONSTRUTORA-NOGMA, "Fase 8 completa" checklist — all 10 items still unchecked (+20 more)

### Community 73 - "DS: formulários"
Cohesion: 0.33
...
Cohesion: 0.12
Nodes (33): abrirPendenciaDeAcao(), arquivarObra(), cadastrarFornecedor(), Client, criarObra(), deErro(), definirContrato(), Escrita (+25 more)

### Community 77 - "E2E Playwright"
Cohesion: 0.21
Nodes (9): fornecedorNome, obraNome, adminClient(), cleanupAllE2E(), cleanupByPrefix(), cleanupDocumentosDeObrasE2E(), cleanupPagamentosDeObrasE2E(), testName() (+1 more)

### Community 78 - "Runbook backup"
Cohesion: 0.12
Nodes (15): 1. Crie um projeto vazio no Supabase, 2. Aplique as migrations nele, 3. Restaure os dados, 4. Confira as contagens, 5. Apague o projeto de teste, 6. Registre, Baixar e decifrar, O que ainda falta (e é ação humana) (+7 more)

### Community 79 - "Runbook Vercel Pro"
Cohesion: 0.50
Nodes (3): amostras, media, medidas

### Community 80 - "index: window.NogmaDesignSystem_54b71f"
Cohesion: 0.31
Nodes (13): window.NogmaDesignSystem_54b71f, site/index.html (React landing page), CTA(), Footer(), Hero(), How(), Nav(), Proof() (+5 more)

### Community 81 - "ALINHAMENTO CAVALCANTI 16 09: /config/webhooks"
Cohesion: 0.12
...
Cohesion: 0.10
Nodes (29): GraficosDaObra(), AbaVisaoGeral(), AtividadeLinha(), TIPO_ICON, CustomTooltip(), DonutCategoria(), DonutCategoriaProps, formatBRL() (+21 more)

### Community 83 - "page: page.tsx"
Cohesion: 0.10
Nodes (31): Documento, DocumentoEnriquecido, DocumentosAgrupados(), ICONE, Tipo, TIPO_LABEL, FILTER_OPTIONS, formatBRL() (+23 more)

### Community 84 - "rate limit: actions.ts"
Cohesion: 0.10
Nodes (29): definirSenha(), log, SenhaSchema, log, login(), Campos, contextoAtual(), cortar() (+21 more)

### Community 85 - "tsconfig.base: tsconfig.base.json"
Cohesion: 0.12
Nodes (15): compilerOptions, allowJs, esModuleInterop, forceConsistentCasingInFileNames, isolatedModules, lib, module, moduleResolution (+7 more)

### Community 86 - "documentos agrupados: documentos-agrupados.tsx"
Cohesion: 0.16
Nodes (17): ehPerguntaAoAssistente(), INTERROGATIVAS, normalizar(), decidirDestino(), Decisao, DepsRoteador, Destino, ehSaudacao() (+9 more)

### Community 88 - "IconButton: mobile-nav.tsx"
Cohesion: 0.05
Nodes (55): GET(), log, naoEncontrado(), redirecionar(), TABELA, chamar(), downloadDocumentBytes, existeObjeto (+47 more)

### Community 90 - "log: log.ts"
Cohesion: 0.13
Nodes (25): brl(), CronogramaFisico(), dataBR(), EtapaLinha(), LinhaOrcado(), OrcadoVsRealizado(), SITUACAO_ROTULO, Client (+17 more)
...
Cohesion: 0.16
Nodes (19): args, cabecalhos, caminhoStorage(), CRIAR_OBRAS, ENSAIO, entrada, extrairZip(), extrairZipEm() (+11 more)

### Community 94 - "n8n integracao: Integração n8n"
Cohesion: 0.09
Nodes (21): 1. Criar webhook no n8n, 1. Slack notification: novo pagamento, 2. OneDrive sync: novo documento, 2. Registrar URL no CRM, 3. Validar signature no n8n (opcional mas recomendado), 3. Weekly digest: cron, 4. Reminder cron: NFs sem comprovante > 7d, 4. Testar (+13 more)

### Community 97 - "planilha: botao-imprimir.tsx"
Cohesion: 0.21
Nodes (10): BotaoImprimir(), formatBRL(), generateMetadata(), PlanilhaPublicaPage(), getPlanilhaPorToken(), LinhaPlanilha, log, Planilha (+2 more)

### Community 98 - "10 verificacao premio seguranca: StatusBanner.ts"
Cohesion: 0.08
...
Cohesion: 0.09
Nodes (41): DIMENSAO_POR_MODELO, embeddingsAtivo(), gerarEmbedding(), gerarEmbeddings(), MAX_LOTE, modeloConfigurado(), paraLiteralVetor(), ResultadoEmbedding (+33 more)

### Community 100 - "04 backend dados: tabela audit_log"
Cohesion: 0.18
Nodes (10): Cobertura, Extensões futuras (Fase 11.x), Fase 11 — Auditoria, Fluxo técnico, Performance, Retenção e LGPD, RLS, Segurança (+2 more)

### Community 101 - "04 backend dados: Auditoria Back-end / Dados 202"
Cohesion: 0.29
Nodes (6): 1.1 Tipos ENUM (`20260903100000_init.sql`), 1.3 Veredicto sobre os pontos obrigatórios do escopo, 1. Schema reconstruído, 2. Matriz das server actions, 5. Tabela final priorizada, Auditoria Back-end / Dados — CRM Nogma-Cavalcanti

### Community 102 - "ROTEIRO DEMO 16 09: ROTEIRO-DEMO-16-09.md"
Cohesion: 0.13
Nodes (14): 1. Painel — `/painel`, 2. Obra — `/obras` → uma obra com movimento, 3. ★ WhatsApp — o fluxo contratado, 4. Pendências — `/pendentes`, 5. Planilha compartilhável — `/obras/[id]` → **Compartilhar**, 6. Relatório do fornecedor — `/relatorios`, 7. O bot responde perguntas — de volta ao celular, A ordem, e por que é essa (+6 more)

### Community 103 - "radii.card: Progress tone="lime""
Cohesion: 0.15
Nodes (14): --petroleum-050 (#F1F7F8), --petroleum-300 (#7FB9C3), --petroleum-800 (#0C4651), Petroleum scale 950→050, Escala petróleo (tints & shades), Cantos & bordas — radii, Rule: radii subtle — never too rounded, --radius-lg (14px) (+6 more)

### Community 104 - "brand theme black.card: Contraste — regras (✓ vá"
Cohesion: 0.17
...
Cohesion: 0.11
Nodes (25): POST(), metadata, PerfilPage(), TEMA_PREVIEW_CLASS, metadata, RootLayout(), viewport, DESCRICAO (+17 more)
...
Cohesion: 0.16
Nodes (22): ALIAS_FORNECEDOR, CABECALHO, casarNota(), CATEGORIA_POR_ETAPA, categoriaDaEtapa(), chaveFornecedor(), dataIso(), ehCabecalho() (+14 more)
...
Cohesion: 0.06
Nodes (56): FornecedoresTable(), FornecedoresPage(), metadata, STATUS_OPTIONS, metadata, ObrasPage(), STATUS_OPTIONS, ObrasTable() (+48 more)

### Community 113 - "09 inventario componentes ui: app/(app)/_shared/"
Cohesion: 0.12
Nodes (16): `app/api/exports/[tipo]/route.ts`, `app/(app)/auditoria/page.tsx`, `app/(app)/config/importar/importar-client.tsx`, `app/(app)/config/page.tsx`, `app/(app)/config/usuarios/page.tsx`, `app/(app)/documentos/documentos-filters.tsx`, `app/(app)/documentos/documentos-table.tsx`, `app/(app)/fornecedores/duplicatas/merge-buttons.tsx` (+8 more)

### Community 114 - "e2e cleanup: auth.spec.ts"
Cohesion: 0.33
Nodes (3): __dirname, obraIds, supabase

### Community 115 - "fase 10 emails: getRecipientsByPapel"
Cohesion: 0.18
Nodes (10): Checkbox unchecked handling, Extensões futuras (Fase 14.x), Fase 14 — Preferências de Usuário, Fluxo, Impacto em Fase 10 (email service), Migration 20260907180000, Radio-cards pattern (tema), Rollback (+2 more)

### Community 116 - "registro: DependenciasDoAssistente"
Cohesion: 0.13
Nodes (16): Data, ehResultadoDeProposta(), lerProposta(), NomeObra, proporArquivarObra, proporCadastrarFornecedor, proporCriarObra, proporDefinirContrato (+8 more)

### Community 117 - "obra: obra.ts"
Cohesion: 0.08
Nodes (44): arquivarCategoria(), assertAdmin(), atualizarCategoria(), criarCategoria(), restaurarCategoria(), ROTULOS_CATEGORIA, ProfileUpdate, ROTULOS_PERFIL (+36 more)

### Community 118 - "pagamento: pagamento.ts"
Cohesion: 0.11
Nodes (22): archivePagamento(), CONTEXTO_FK, createPagamento(), formToRecord(), restorePagamento(), ROTULOS, updatePagamento(), clienteDeServico() (+14 more)

### Community 119 - "06 ultra maximo arquitetura escala: CONFIANCA_AU"
Cohesion: 0.17
Nodes (11): 1. Veredito arquitetural geral, 2.1 — CRÍTICO: o schema e o RLS são single-tenant "por ausência", não por decisão, 2.2 — ALTO: `packages/db` é um pacote de fachada — não existe fronteira real de domínio, 2.3 — ALTO: lógica de negócio financeira vive em blobs JSON dentro de um markdown, fora de qualquer controle de versão, 2.4 — MÉDIO-ALTO: autorização duplicada 5x — e o padrão vai precisar mudar quando o RLS ficar multi-tenant, 2.5 — MÉDIO: nenhuma camada de fila/assincronia entre "mensagem chegou" e "IA processou" — o webhook *é* o processamento, 2.6 — MÉDIO: testabilidade tem um bom começo (interfaces de IA/Email) que o resto do código não segue, 2.7 — MÉDIO: custo de IA e de PDF não tem *nenhum* mecanismo de limite — e ele multiplica por tenant, não soma (+3 more)

### Community 120 - "tsconfig: tsconfig.json"
Cohesion: 0.17
...
Cohesion: 0.20
Nodes (9): Briefing Cavalcanti — alinhamento para entrega 16/09, Contato e validação com o cliente, Dados e organização, Diretriz de entrega, Fluxo principal via WhatsApp, Infraestrutura, Interface e ajustes, Pendências (+1 more)

### Community 123 - "PROTOTIPO PORTADO: PROTOTIPO-PORTADO.md"
Cohesion: 0.17
Nodes (11): 1. Planilha do cliente, com link compartilhável — o item nº 1 do inventário, 2. Comandos de texto do bot, 3. Semáforo de dias nas pendências, 4. Barra de consumo do orçamento, 5. Banner de alertas no painel, 6. Documentos agrupados por fornecedor ou por obra, Deliberadamente NÃO portado, O que veio do protótipo do Cavalcanti para o CRM (+3 more)

### Community 124 - "package: package.json"
Cohesion: 0.17
Nodes (11): exports, ./types, name, peerDependencies, @supabase/supabase-js, private, scripts, gen-types (+3 more)

### Community 126 - "11 backend verificacao migrations indices: confi"
Cohesion: 0.08
Nodes (24): 1 — Resumo executivo, 2 — Findings por severidade, 3 — Tabela de prioridades, 🟠 ALTO, Auditoria Backend/DB — CRM Nogma-Cavalcanti (segunda passagem, migrations/índices), 🟢 BAIXO / INFO, 🔴 CRÍTICO, F-01 — `confirmacoes_pendentes`: zero índices além da PK, em tabela no hot-path do classificador (+16 more)

### Community 127 - "fase 16 categorias: 11 F-03 Unique global em cat"
Cohesion: 0.20
Nodes (9): Contagem de uso, Cores permitidas, Extensões futuras (Fase 16.x), Fase 16 — Sistema de Categorias, Fluxo, Impacto em outras fases, O que existe, Rollback (+1 more)

### Community 129 - "apply migration: Checklist do engenheiro de rele"
Cohesion: 0.20
...
Cohesion: 0.14
Nodes (13): dsCard: Posts / carrossel (miniatura do modelo), 10. Site & apresentações, 1. Arquivos, 2. Fundamentos visuais, 3. Fundo "dark-tech", 4. Intersecção — o "nó" (motivo recorrente), 5. Componentes (classes em `system.css`), 6. Regras de copy (+5 more)

### Community 132 - "03 frontend: obras-table.tsx"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (17): archiveFornecedor(), createFornecedor(), extractDoc(), formToRecord(), restoreFornecedor(), ROTULOS_FORNECEDOR, updateFornecedor(), documentoOptional (+9 more)

### Community 139 - "comandos: comandos.ts"
Cohesion: 0.13
Nodes (17): comErro(), confirmarPendencia(), escolherObraPendencia(), rejeitarPendencia(), revalidarTudo(), agruparPorFornecedor(), CardPendenciaDeAcao(), CardPendenciaDeObra() (+9 more)

### Community 140 - "fase 12 e2e: Fase 12 Testes E2E com Playwright"
Cohesion: 0.11
Nodes (18): 1. Criar projeto staging (manual, 2 min), 2. Salvar credenciais localmente, 3. Aplicar migrations no staging, 4. Criar usuário admin de teste no staging, 5. Configurar hCaptcha no staging, 6. Provisionar env vars Vercel Preview, 7. Configurar secrets GitHub Actions, 8. Testar workflow (+10 more)

### Community 141 - "pos vercel pro: Item 5 Vercel Pro um comando faz"
Cohesion: 0.28
Nodes (8): args, falhar(), H, medidas, REPO_PRIVADO, SO_MEDIR, ultimoDeployProd(), vercel()

### Community 142 - "feedback.card: Alert"
Cohesion: 0.46
Nodes (8): Alert, Button, Dialog, Nogma DS Bundle (_ds_bundle.js, window.NogmaDesignSystem_54b71f), Feedback Card (Alert · Progress · Tooltip · Dialog), IconButton, Progress, Tooltip

### Community 143 - "brand intersecao.card: assets/intersecoes/10.png"
Cohesion: 0.20
Nodes (10): assets/intersecoes/10.png, Seam between slides: same image, same width+top; left(b) = left(a) − slide width, Intersecção (o nó) — pontas fora do quadro + emenda entre slides, Intersecção motif (the knot stroke), Rule: stroke endings always outside the frame (no visible hook), assets/isotype-n-lime.png, assets/isotype-n-petroleum.png, Isotype as app icon (22px radius) and favicon (10px radius) (+2 more)

### Community 144 - "test webhook uazapi: test-webhook-uazapi.mjs"
Cohesion: 0.20
Nodes (7): body, __dirname, __filename, fixturePath, { positional, flags }, signature, t0

### Community 146 - "consumidor.test: Handler"
Cohesion: 0.18
Nodes (13): AnthropicClassifier, log, montarConteudo(), carregarMidia(), DepsClassificador, log, MIMES_IMAGEM, mimeSuportado() (+5 more)

### Community 148 - "Tabs.prompt: Rule: Dialog is controlled, closes "
Cohesion: 0.40
Nodes (5): Navigation — Tabs Card, Tabs, Tabs item `count` badge, Tabs variant="line" (underline, page-level nav), Tabs variant="pill" (segmented, compact filters)

### Community 149 - "color petroleum scale.card: --petroleum-050 (#F1"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (23): TIPO_VARIANT, STATUS_LABEL, STATUS_VARIANT, RelatoriosForms(), RelatoriosFormsProps, colunaDeSituacao(), ORDEM, AvisoDeFalta() (+15 more)

### Community 151 - "not found: error.tsx"
Cohesion: 0.10
Nodes (17): APLICAR, catsArquivar, FATOS_DAS_OBRAS, fornArquivar, fornLimpar, fornReais, H, obrasArquivar (+9 more)
...
Cohesion: 0.19
Nodes (15): alternarAutomacao(), assertPodeConfigurar(), salvarConfigAutomacao(), simularAutomacoes(), AutomacoesPage(), metadata, STATUS_ROTULO, descreverCampos() (+7 more)

### Community 155 - "apply migrations staging: 5.2 Migrations process"
Cohesion: 0.50
Nodes (3): __dirname, files, MIGRATIONS_DIR

### Community 156 - "checar integracoes: Inventario real de producao "
Cohesion: 0.29
Nodes (4): INTEGRACOES, porNome, producao, ultimaMudanca

### Community 157 - "brand isologo.card: assets/logo-nogma-lime.png"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (19): APLICAR, args, conversaIds, del(), desde, docsIds, eventosFiltro, filtros (+11 more)

### Community 160 - "inventario lib apps web: Threshold de auto-aprov"
Cohesion: 0.09
Nodes (21): 1. `lib/ia/` — AI classifier (CRITICAL FINDINGS), 2. `lib/services/`, 3. `lib/schemas/`, 4. `lib/email/`, 5. Storage, webhooks, Supabase, theme, util, 6. `lib/reports/`, 7. `lib/data/` — 14 files, one line each, 8. Grep results: TODO / FIXME / mock / stub / placeholder / "not implemented" / `@ts-expect-error` (+13 more)

### Community 161 - "provisionar vault: Se algo der errado tabela de "
Cohesion: 0.47
Nodes (5): BASE, lit(), passos, sql(), upsertSegredo()

### Community 162 - "tsconfig: tsconfig.json"
Cohesion: 0.29
Nodes (6): compilerOptions, noEmit, outDir, rootDir, extends, include

### Community 163 - "page: GET()"
Cohesion: 0.30
Nodes (12): RecebimentosDaObra(), Client, executarComando(), formatBRL(), gastoDaObra(), pendencias(), resumo(), formatador (+4 more)

### Community 165 - "busca: busca.ts"
Cohesion: 0.23
Nodes (9): SaidaSchema, corpoDaChamada(), JSON_SCHEMA_SAIDA, log, montarConteudoOpenAI(), OpenAIClassifier, OBRAS, respostaOk() (+1 more)

### Community 168 - "fase 17 dashboard: KPIs com historia parcial sem"
Cohesion: 0.17
Nodes (11): Charts (Recharts client wrappers), Data layer (`lib/data/painel.ts`), Deltas mensais, Extensões futuras (Fase 17.x), Fase 17 — Dashboard advanced, Impacto em outras fases, O que mudou, Rollback (+3 more)

### Community 169 - "color lime status.card: Alert variants: success "
Cohesion: 0.18
Nodes (11): Alert variants: success · warning · danger, Field `error` prop (danger state), --lime-600 (#A3CC00), Lime scale 600→050, Escala lime + status, Semantic status colors (tint background + text), Danger (#FBE9E7 bg · #D6483B text), Success (#E7F5EE bg · #2FA36B text) (+3 more)

### Community 170 - "brand lime motif.card: Lime full-stop / key numb"
Cohesion: 0.11
Nodes (17): Backgrounds, Borders, Cards, Color, CONTENT FUNDAMENTALS — how Nogma writes, Corners — "cantos sutis", Elevation / shadows, ICONOGRAPHY (+9 more)

### Community 173 - "bar serie mensal: bar-serie-mensal.tsx"
Cohesion: 0.12
Nodes (16): 10 · Custo — deve ficar zero, 11 · Suporte, 1 · Login/criar conta Vercel, 2 · Ativar MFA na sua conta Vercel (importante — 30 s), 3 · Criar/entrar no Team `NogmaBR`, 4 · Instalar o GitHub App "Vercel" na org NogmaBR, 5 · Importar o repositório, 6.1 · Deployment Protection (+8 more)

### Community 174 - "donut categoria: donut-categoria.tsx"
Cohesion: 0.12
Nodes (15): 1. Baixar Chromium (uma vez), 2. Resolver hCaptcha (obrigatório), 3. Rodar suite completa, 4. Ver report HTML, CI (não implementado), Cobertura de testes, Extensões futuras (Fase 12.x), Fase 12 — Testes E2E com Playwright (+7 more)

### Community 180 - "pagamentos filters: pagamentos-filters.tsx"
Cohesion: 0.13
Nodes (22): fmt(), metadata, WhatsappDiagnosticoPage(), avaliarWebhook(), Checagem, config(), get(), log (+14 more)

### Community 187 - "Button.d: Button.d.ts"
Cohesion: 0.50
Nodes (3): ButtonProps, ButtonSize, ButtonVariant

### Community 188 - "IconButton.d: IconButton.d.ts"
Cohesion: 0.50
Nodes (3): IconButtonProps, IconButtonSize, IconButtonVariant

### Community 228 - "vitest.config: vitest.config.ts"
Cohesion: 0.13
Nodes (15): 1.2 Tabelas, `audit_log`, `autorizados`, `categorias`, `confirmacoes_pendentes`, `documentos`, `fornecedor_apelidos`, `fornecedores` (+7 more)

### Community 229 - "Community 229"
Cohesion: 0.13
Nodes (15): 3. Findings numerados, 🔴 F-01 — O CI não existe: `.github/` nunca foi commitado, 🔴 F-02 — `pnpm -r test` quebra: `vitest` não está instalado, 🔴 F-03 — Funções Vercel em `iad1`, banco em `sa-east-1`: ~120 ms de RTT por query, 🔴 F-04 — `maxDuration` e `memory` não declarados nas rotas pesadas, 🔴 F-05 — Migrations sem controle: sem registro, sem transação, sem rollback, sem drift, 🔴 F-06 — Nenhum backup, nenhum plano de recuperação, doc fantasma no README, 🔴 F-07 — ~40.500 arquivos estranhos no working tree (+7 more)

### Community 230 - "Community 230"
Cohesion: 0.13
Nodes (14): 1. Criar conta, 2. Verificar domínio (recomendado), 3. Provisionar env vars, 4. Redeploy Vercel, 5. Testar, Arquitetura de arquivos, Como plugar Resend (produção), Custo estimado (+6 more)

### Community 231 - "Community 231"
Cohesion: 0.13
Nodes (14): 1. CSS globals a11y (`apps/web/styles/a11y.css`), 2. Root layout skip link, 3. App shell semantic (`(app)/layout.tsx`), 4. Sidebar nav, 5. Sonner Toaster wired, 6. StatusBanner reutilizável, Checklist WCAG AA — status, Extensões futuras (Fase 20.x) (+6 more)

### Community 232 - "Community 232"
Cohesion: 0.13
Nodes (15): Convenções, Fase 1 — Design System (Nogma DS integração direta), Fase 3 — Schema Postgres + RLS, Plano #1 v2 — Fundações com Nogma DS integração direta, Self-review (v2), Task 1.1: Bootstrap Next.js 15 no monorepo, Task 1.2: Copiar assets Nogma DS (tokens, fontes, logos, ícones), Task 1.3: Root layout com `data-theme` + cookie persistence (+7 more)

### Community 233 - "Community 233"
Cohesion: 0.15
Nodes (13): 7.1 Layout global (`app/(app)/layout.tsx`), 7.2 Detalhamento por tela, 7.3 Componentes reutilizáveis chave, 7. Módulos e telas, `/config`, `/documentos`, `/fornecedores`, `/obras` (+5 more)

### Community 234 - "Community 234"
Cohesion: 0.17
Nodes (11): Estados visuais, Extensões futuras (Fase 13.x), Fase 13 — Gestão de Usuários + Convites, Fluxo de convite, Middleware, Papéis (RLS enforced), Segurança, Server actions (+3 more)

### Community 235 - "Community 235"
Cohesion: 0.20
Nodes (9): 1. Resumo por severidade, 2. Findings, 3. Confirmado sem regressão (já fixado nas rodadas anteriores), 4. Checklist acionável (por prioridade), ALTO, Auditoria de Segurança Adversarial — CRM-CONSTRUTORA-NOGMA, BAIXO / INFORMATIVO, CRÍTICO (+1 more)

### Community 236 - "Community 236"
Cohesion: 0.20
Nodes (10): ✅ Checklist de teste end-to-end, Full flow WhatsApp end-to-end, Setup base, WF1 · UAZAPI bridge (só Pattern B), WF2 · Slack pagamento, WF3 · Sheets log, WF4 · Drive sync, WF5 · Reminder NFs (+2 more)

### Community 237 - "Community 237"
Cohesion: 0.20
Nodes (9): Passo 1: Criar projeto, Passo 2: Coletar credenciais, Passo 3: Habilitar extensions, Passo 4: Instalar Supabase CLI, Passo 5: Linkar projeto local (executar após Task 3.1 do plano), Passo 6: Criar usuário admin de teste, Referências, Setup Supabase (uma vez) (+1 more)

### Community 238 - "Community 238"
Cohesion: 0.20
Nodes (10): 11. Roadmap fásico, 12. Riscos e mitigações, 13. Extras V2 (fora deste MVP), 14. Referências, 1. Contexto e motivação, 3. Decisões arquiteturais, 5. Estrutura do repositório, 9. Segurança e permissões (+2 more)

### Community 239 - "Community 239"
Cohesion: 0.22
Nodes (9): 7. Acessibilidade (A11y), CHECK PASS — Botoes icon-only com aria-label, CHECK PASS — focus-visible global, CHECK PASS — Landmarks semanticos, CHECK PASS — prefers-reduced-motion, CHECK PASS — Skip link funcional, INFO — `sr-only` e min touch target implementados, MED — Avatar com alt text verbose em contexto decorativo (+1 more)

### Community 240 - "Community 240"
Cohesion: 0.22
Nodes (9): 4. Migrations recomendadas, Migration A — Índices, CHECKs e correções de modelagem, Migration B — `has_role()` respeita soft-delete, Migration C — `audit_log` append-only, com autor e sem dados sensíveis, Migration D — Constraints de unicidade que faltam, Migration E — Índice de hash de documento tolerante a rascunho, Migration F — Idempotência do import CSV, Migration G — `confirmar_pendencia_atomic` (+1 more)

### Community 241 - "Community 241"
Cohesion: 0.22
Nodes (9): 2.1 `pnpm install --frozen-lockfile` — ✅ EXIT 0, 2.2 `pnpm lint` — ❌ EXIT 1, 2.3 `pnpm typecheck` — ✅ EXIT 0, 2.4 `pnpm -r test` — ❌ EXIT 1, 2.5 `cd apps/web && pnpm build` — ✅ EXIT 0, 2.6 `pnpm outdated -r` — EXIT 1 (há desatualizados), 2.7 `pnpm audit` — ✅ EXIT 0, 2.8 Correção de uma premissa do escopo: Tailwind **não** é alpha em produção (+1 more)

### Community 242 - "Community 242"
Cohesion: 0.22
Nodes (8): Arquivos, Bloco 2 — o fluxo do WhatsApp ligado ponta a ponta, Decisões que valem registro, O que existia antes, O que falta — e não é código, O que passou a existir, Também entrou, Verificação

### Community 243 - "Community 243"
Cohesion: 0.22
Nodes (9): 📦 7 workflows prontos pra importar, Como importar, WF1 — UAZAPI → CRM (bridge com HMAC assinado), WF2 — Slack notif: pagamento novo > R$5k, WF3 — Google Sheets: log de todos os pagamentos, WF4 — OneDrive/Google Drive: sync de documentos, WF5 — WhatsApp reminder: NFs sem comprovante > 7d (cron diário), WF6 — Weekly digest email (sexta 18h) (+1 more)

### Community 244 - "Community 244"
Cohesion: 0.20
Nodes (9): Decisões humanas em aberto (não são código), Design review (2026-09-12) — adiados [DEPOIS DE 16/09], P0 — o núcleo do contrato (CEO review, 2026-09-12), P1 — antes de ligar WhatsApp/automações em produção, P2 — qualidade e segurança, P3 — higiene, Plano master de 2026-09-18 — o que ficou de backlog, QA ao vivo (2026-09-12) — adiados com contexto (+1 more)

### Community 245 - "Community 245"
Cohesion: 0.23
Nodes (10): CampoConfig, cobrarDocumentoFornecedor, orcamentoEmRisco, APP_URL, resumoDiarioSemaforo, AutomacaoListada, AutomacaoAgendada, ContextoExecucao (+2 more)

### Community 246 - "Community 246"
Cohesion: 0.25
Nodes (8): C1 — Supabase API (READ+WRITE direto), C2 — Anthropic Claude API, C3 — CRM Webhook HMAC (secret compartilhado), C4 — UAZAPI outbound (envio de WhatsApp), C5 — Slack (workspace Cavalcanti), C6 — Google Sheets (log de pagamentos), C7 — OneDrive OU Google Drive (sync de documentos), 🔐 Credentials — 7 pra criar

### Community 247 - "Community 247"
Cohesion: 0.25
Nodes (8): Claude classifier retorna kind sempre `nao_identificado`, Drive upload retorna 403 quota exceeded, Google Sheets Append duplica linhas, "HMAC signature inválida" no Code node, Supabase node retorna array vazio, 🐛 Troubleshooting, UAZAPI send retorna 401, Webhook n8n não dispara

### Community 248 - "Community 248"
Cohesion: 0.25
Nodes (8): 4.1 Fonte da verdade, 4.2 Paleta, 4.3 Tipografia, 4.4 Espaçamento & radii, 4.5 Elevação & motion, 4.6 Três temas via `data-theme`, 4.7 Motivos de marca, 4. Design System — Nogma

### Community 249 - "Community 249"
Cohesion: 0.25
Nodes (7): **Análise da Imagem 1: Tela "Fornecedores" (`image.png`)**, **Análise da Imagem 2: Tela "Gestão de Obras" (`image_2.png`)**, **Análise da Imagem 3: Tela "Pendências" (`image_3.png`)**, **Análise da Imagem 4: Tela "Documentos" (`image_4.png`)**, **Análise da Imagem 5: Tela "Painel" Dashboard (`image_5.png`)**, **Análise da Imagem 6: Tela "Fila WhatsApp" (`image_6.png`)**, **Elementos Comuns em Todas as Telas (Menu Lateral e Usuário)**

### Community 250 - "Community 250"
Cohesion: 0.09
Nodes (26): log, POST(), mapTipoToDb(), MsgTipoDb, MsgTipoUazapi, UazapiInboundSchema, uazapiMedia, resposta429() (+18 more)

### Community 251 - "Community 251"
Cohesion: 0.23
Nodes (13): casarObra(), categoriaDaPasta(), ehLixo(), EXCECOES_OBRA, LIXO, MIME_POR_EXTENSAO, mimeDaExtensao(), normalizarNome() (+5 more)

### Community 252 - "Community 252"
Cohesion: 0.14
Nodes (13): ⏳ 10. Depois de 16/09, 🔵 11. Decisão: Fase 6 (vendas) — o que preciso de você, 2.1 — O redeploy, que todo mundo esquece, 🔴 2. Credenciais + redeploy, 🟠 5. Vercel Pro → um comando faz o resto, 🟡 8. Indexar a base de conhecimento, Checklist final, Como conferir (+5 more)

### Community 253 - "Community 253"
Cohesion: 0.29
Nodes (6): 3. Client Bundle, Auditoria Frontend + Infraestrutura — CRM Nogma-Cavalcanti, CHECK PASS — Separacao client/server, Legenda, MED — Recharts em 3 chart components sem lazy loading, Resumo de Findings

### Community 254 - "Community 254"
Cohesion: 0.29
Nodes (7): 6.1 Núcleo, 6.2 Pagamentos e documentos, 6.3 Bot WhatsApp, 6.4 Suporte, auditoria, cron, 6.5 Views materializadas (Painel), 6.6 RLS (políticas), 6. Modelo de dados (Supabase Postgres)

### Community 255 - "Community 255"
Cohesion: 0.29
Nodes (6): Composition, Files, NogmaOS — UI Kit, Notes, Screens (`index.html`, click-through), Theme

### Community 256 - "Community 256"
Cohesion: 0.33
Nodes (6): 1. XSS, CHECK PASS — href dinamico / open redirect, CHECK PASS — Imagens dinamicas de avatar, CHECK PASS — innerHTML unsafe, CHECK PASS — URL params ecoados sem escape (?error= / ?success=), HIGH — iframe sem allow-scripts bloqueado (email preview)

### Community 257 - "Community 257"
Cohesion: 0.33
Nodes (6): 2. CSRF, CHECK PASS — Cron endpoint — protegido por CRON_SECRET, CHECK PASS — Server Actions Next.js, CHECK PASS — Webhooks — HMAC substitui CSRF, INFO — Supabase-SSR cookies, MED — Cookie de tema sem flag Secure

### Community 258 - "Community 258"
Cohesion: 0.33
Nodes (6): 5.2 Migrations — processo mínimo confiável, Fluxo diário a partir daí, Manter o `.mjs` como quebra-galho, com uma trava, Migrar para o fluxo padrão do Supabase CLI (uma vez), O que ganha em relação ao `apply-migration.mjs`, Rollback
...
Cohesion: 0.20
Nodes (15): alternarAtivoAutorizado(), assertAdmin(), atualizarAutorizado(), criarAutorizado(), ROTULOS_AUTORIZADO, AutorizadosPage(), metadata, AutorizadoCreateInput (+7 more)

### Community 262 - "Community 262"
Cohesion: 0.40
Nodes (5): 8. Performance, CHECK PASS — Font display: swap, CHECK PASS — next/image usado corretamente, MED — Nenhum empty state em tabelas, MED — Nenhum `loading.tsx` em nenhuma rota

### Community 263 - "Community 263"
Cohesion: 0.40
Nodes (5): 5.1 GitHub Actions — pipeline recomendado, 5.5 `.gitignore` corrigido, 5. Entregáveis prontos pra colar, `.github/workflows/ci.yml` — gate de qualidade (NOVO), `.github/workflows/e2e.yml` — correções pontuais no existente

### Community 264 - "Community 264"
Cohesion: 0.40
Nodes (5): 5.4 Observabilidade mínima — custo zero, Alertas — três, todos free, Health check — `apps/web/app/api/health/route.ts` (NOVO), `latency_ms` como métrica de F-03, Logger estruturado — `apps/web/lib/util/logger.ts` (NOVO)

### Community 265 - "Community 265"
Cohesion: 0.40
Nodes (5): 5.6 Seed de desenvolvimento e scripts de DX, Correções no `README.md`, Scripts a adicionar no `package.json` da raiz, `scripts/check-env.mjs` (NOVO — evita "faltou uma var em prod"), `supabase/seed.sql` — expandido (esboço)

### Community 266 - "Community 266"
Cohesion: 0.40
Nodes (5): HTTP Request node — chamar Claude, 🤖 Prompts Claude — templates prontos, Schema JSON pra tool_use, System prompt (fixo), User prompt template (renderizado a cada mensagem)

### Community 267 - "Community 267"
Cohesion: 0.40
Nodes (5): Fase 0 — Setup do repositório, Task 0.1: Verificar estado inicial e mover artefatos legados, Task 0.2: git init + .gitignore + .gitattributes, Task 0.3: Monorepo scaffold (pnpm workspaces), Task 0.4: Docs de setup manual (Supabase + Vercel)

### Community 268 - "Community 268"
Cohesion: 0.40
Nodes (5): 10.1 Testes, 10.2 CI (GitHub Actions), 10.3 DX, 10.4 Observabilidade, 10. Testes, DX e observabilidade

### Community 269 - "Community 269"
Cohesion: 0.40
Nodes (5): 8.1 Diagrama, 8.2 Auto-aprendizado, 8.3 Prompts e schemas, 8.4 Fallback e resiliência, 8. Fluxo end-to-end do bot WhatsApp

### Community 270 - "Community 270"
Cohesion: 0.40
Nodes (4): Composition, Nogma Site — UI Kit, Notes, Sections

### Community 271 - "Community 271"
Cohesion: 0.50
Nodes (4): 5. Vercel Config, CHECK PASS — Cron configurado corretamente, CHECK PASS — Middleware matcher correto, CRIT — Security Headers ausentes em `next.config.ts`

### Community 272 - "Community 272"
Cohesion: 0.50
Nodes (4): 6. GitHub Actions, CHECK PASS — Secrets via `${{ secrets.* }}` — sem hardcode, INFO — Actions oficiais com versoes fixas, MED — Action de terceiro sem SHA pinned

### Community 273 - "Community 273"
Cohesion: 0.50
Nodes (4): 9. PWA / Meta, HIGH — Sem manifest.json / PWA, HIGH — Sem OpenGraph / meta tags sociais, INFO — Favicon excluido do middleware

### Community 274 - "Community 274"
Cohesion: 0.50
Nodes (4): Backlog, Imediato (antes do proximo deploy producao), Prioridade de Execucao, Proximo sprint

### Community 275 - "Community 275"
Cohesion: 0.50
Nodes (4): Backup dos workflows, 🔒 Segurança + backups, Segurança dos workflows, Versionamento

### Community 276 - "Community 276"
Cohesion: 0.50
Nodes (4): Fase 2 — Autenticação Supabase, Task 2.1: Supabase clients (browser + server + middleware), Task 2.2: Login screen (LoginScreen NogmaOS), Task 2.3: UserMenu real com logout

### Community 277 - "Community 277"
Cohesion: 0.50
Nodes (4): 2.1 In-scope (MVP), 2.2 Non-goals (V2 ou depois), 2.3 Restrições explícitas, 2. Escopo

### Community 278 - "Community 278"
Cohesion: 0.67
Nodes (3): 4. Env Vars, CHECK PASS — NEXT_PUBLIC_* sao todos seguros para client, MED — `.env.example` incompleto
...
Cohesion: 0.10
Nodes (33): arquivarWebhook(), assertAdmin(), atualizarWebhook(), AtualizarWebhookSchema, criarWebhook(), CriarWebhookSchema, EVENTOS_VALIDOS, regenerarSecret() (+25 more)

### Community 1913 - "Community 1913"
Cohesion: 0.13
Nodes (36): AbaAlertas(), GRAVIDADE_ROTULO, alertasDoEmpresario(), carregarBase(), Client, dadosCaixa, dadosDocumentos, dadosFornecedores (+28 more)

### Community 1914 - "Community 1914"
Cohesion: 0.17
Nodes (14): Automacao, Client, log, OpcoesEmissao, EventosDocumento, EventosFornecedor, EventosObra, EventosPagamento (+6 more)

### Community 1915 - "Community 1915"
Cohesion: 0.14
Nodes (13): 5b — o roteador (`lib/whatsapp/roteador.ts` + `lib/ia/intencao.ts`), A pendência de ação e o SIM (`lib/services/acoes-whatsapp.ts`), Agente do WhatsApp que responde e age sobre o CRM inteiro — design, Banco (`supabase/migrations/20260916230000_contrato_recebimentos_acoes.sql`), Classificador: obra sugerida pela conversa, Decisões fechadas, Erros e degradação, O assistente (`lib/ia/assistente.ts`) (+5 more)

### Community 1917 - "Community 1917"
Cohesion: 0.17
Nodes (11): apelidosOptional, enderecoSchema, isoDateOptional, ObraCreateInput, ObraStatus, obraStatusEnum, ObraTipo, obraTipoEnum (+3 more)

### Community 1918 - "Community 1918"
Cohesion: 0.17
Nodes (7): APP, args, BASE, desejado, destino, H, { nosso, problemas }

### Community 1919 - "Community 1919"
Cohesion: 0.13
Nodes (23): INSTRUCOES, lerComVisao(), log, visaoDisponivel(), MidiaCarregada, classificarIntencao(), DepsIntencao, Intencao (+15 more)

### Community 1920 - "Community 1920"
Cohesion: 0.17
Nodes (11): Agente do WhatsApp — CRM completo: plano de implementação, Mapa de arquivos, Task 1: Migration + tipos, Task 2: Dado no painel (contrato + recebimentos), Task 3: Ferramentas de leitura (`ferramentas/crm.ts`), Task 4: Ferramentas de ação (`ferramentas/acoes.ts`) + templates, Task 5: `acoes-whatsapp.ts`, Task 6: Memória curta + intenção + roteador (+3 more)

### Community 1921 - "Community 1921"
Cohesion: 0.25
Nodes (8): 12.1 — Baixar o ZIP do OneDrive, 12.2 — Mergear o PR e aplicar a migration, 12.3 — Apelidos das obras e a obra Aguirre, 12.4 — Importar o acervo, 12.5 — Cadastrar o grupo, 12.6 — Trocar os pagamentos do protótipo pelos reais (uma linha), 12.7 — Tirar o que sobrou do protótipo (uma linha), ⏳ 12. Depois de 16/09 — acervo do OneDrive e agente no grupo
...
Cohesion: 0.11
Nodes (23): GET(), log, GET(), log, GET(), log, GET(), GET() (+15 more)
...
Cohesion: 0.16
Nodes (15): ModeloAnthropic, DependenciasDoAssistente, Chamada, ferramenta, paraAnthropic(), CriarModelo, criarModeloPadrao(), ModeloComFerramentas (+7 more)
...
Cohesion: 0.23
Nodes (8): AppLayout(), contarPendencias(), perfilArquivado(), logout(), EventoDeInstalacao, InstalarApp(), Sidebar(), UserMenu()

### Community 1932 - "Community 1932"
Cohesion: 0.09
Nodes (22): compararObras(), contarPorPasta(), Data, diarioDaObra, documentosDaObra, FERRAMENTAS_CRM, gastoPorEtapa, Limite (+14 more)
...
Cohesion: 0.25
Nodes (6): aqui, args, ENSAIO, entrada, h, sql()

### Community 1935 - "Community 1935"
Cohesion: 0.38
Nodes (5): BarSerieMensal(), BarSerieMensalProps, CustomTooltip(), formatBRL(), BarrasHorizontais()

### Community 1936 - "Community 1936"
Cohesion: 0.33
Nodes (5): args, existentes, h, lista, vars

### Community 1937 - "Community 1937"
Cohesion: 0.18
Nodes (10): Auto-revisão, Diagnóstico (2026-09-16), Registro da execução (2026-09-16), Restrições globais, Tarefa 1 — Rota de arquivo: `/api/arquivos/[origem]/[id]`, Tarefa 2 — `VisualizadorDeArquivo` e `Miniatura`, Tarefa 3 — Telas, Tarefa 4 — Ingestão WhatsApp completa (+2 more)

### Community 1938 - "Community 1938"
Cohesion: 0.21
Nodes (15): GraficosDoFornecedor(), AbaCaixa(), AbaDocumentos(), AbaFornecedores(), AbaPorObra(), ABAS, metadata, PainelPage() (+7 more)

### Community 1939 - "Community 1939"
Cohesion: 0.26
Nodes (10): dataLegivel(), DIAS, EntradaDoResumoDiario, lerTelefones(), linhaDoCadastro(), montarResumoDiario(), ResumoDeNiveisTexto, zero (+2 more)

### Community 1940 - "Community 1940"
Cohesion: 0.38
Nodes (5): extensaoPara(), log, ResultadoTranscricao, transcreverAudio(), transcreverComOpenAI()

### Community 1941 - "Community 1941"
Cohesion: 0.33
Nodes (6): 13.1 — O que você precisa ter em mão, 13.2 — Ligar (5 minutos, três comandos e uma tela), 13.3 — Roteiro de testes (o que mandar, o que tem que acontecer), 13.4 — Limpar os testes (uma linha), 13.5 — Trocar para o número oficial do Cavalcanti (os mesmos comandos), 13. Fase de testes com o SEU número, depois o número do cliente

### Community 1942 - "Community 1942"
Cohesion: 0.10
Nodes (29): CategoriaRow(), CategoriasPage(), FILTER_OPTIONS, formatBRL(), metadata, StatusFilter, FornecedorForm(), EditarFornecedorPage() (+21 more)

### Community 1943 - "Community 1943"
Cohesion: 0.10
Nodes (33): arquivarEtapa(), arquivarOrcamentoEtapa(), criarEtapa(), criarEtapasDoPlano(), ERROS_DB, formToRecord(), medirEtapa(), paginaDaObra() (+25 more)

### Community 1944 - "Community 1944"
Cohesion: 0.12
Nodes (25): EditarPagamentoPage(), metadata, formatDate(), formatDateTime(), metadata, ORIGEM_LABEL, PagamentoDetailPage(), PagamentoForm() (+17 more)
...
Cohesion: 0.24
Nodes (11): BarrasPorObra(), CaixaMensal(), LinhaCaixa, SaldoAcumulado(), brlCurto(), corDaSerie(), EIXO, ItemTooltip (+3 more)

### Community 1947 - "Community 1947"
Cohesion: 0.18
Nodes (7): AutomacaoCampos(), formatarPadrao(), LeitorDeCampos, montarAjuda(), rotuloDaChave(), ROTULOS_CONFIG, TipoCampo

### Community 1948 - "Community 1948"
Cohesion: 0.21
Nodes (10): Client, conversaRecente(), curto(), FiltroMemoria, formatarConversa(), log, AGORA, banco() (+2 more)
...
Cohesion: 0.24
Nodes (9): banco(), rodar(), Client, executarFerramenta(), ResultadoFerramenta, eco, explode, fake (+1 more)

### Community 1952 - "Community 1952"
Cohesion: 0.31
Nodes (8): alternarAtivoGrupo(), assertAdmin(), atualizarObraDoGrupo(), criarGrupo(), ROTULOS, GrupoCreateInput, GrupoCreateSchema, GrupoUpdateSchema

### Community 1953 - "Community 1953"
Cohesion: 0.31
Nodes (8): montarSaida(), Nomeado, normalizarNome(), parece(), resolverPorNome(), FORN, OBRAS, tokens()

### Community 1954 - "Community 1954"
Cohesion: 0.18
Nodes (10): 1. O que o usuário pediu (em uma frase cada), 2.1 O conceito, 2.2 As regras por entidade, 2.3 Onde aparece, 2.4 Dados, 2. Semáforo de completude, 3. Gráficos novos, 4. Plano master — o que entra agora e o que fica de backlog (+2 more)
...
Cohesion: 0.28
Nodes (7): APLICAR, H, rest(), semCor, corAutomatica(), hashTexto(), PALETA_AUTO

### Community 1957 - "Community 1957"
Cohesion: 0.31
Nodes (7): CARDINAIS, formatarOpcoes(), interpretarEscolha(), normalizar(), ORDINAIS, PARTICULAS, OPCOES
...
Cohesion: 0.39
Nodes (6): adicionarApelido(), ApelidoSchema, removerApelido(), ApelidosSection(), findApelidoConflict(), FornecedorApelido

### Community 1960 - "Community 1960"
Cohesion: 0.47
Nodes (4): BarraDeDinheiro(), brl(), dataBR(), LinhaDoTempo()

### Community 1962 - "Community 1962"
Cohesion: 0.40
Nodes (4): cab, ENSAIO, principal(), SEED
...
Cohesion: 0.40
Nodes (4): LABEL, ORDEM, ThemeToggle(), Theme
...
- `Tema: preto como superficie escura primaria` → `Classes nos-* (sidebar, topbar, tablecard, agentcard, login, chat)`  [AMBIGUOUS]
  Nogma Design System/ui_kits/nogmaos/index.html · relation: implements

## Knowledge Gaps
- **3842 isolated node(s):** `NG_PATHS`, `ButtonVariant`, `ButtonSize`, `ButtonProps`, `IconButtonVariant` (+3837 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1696 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **What is the exact relationship between `Supabase (PostgreSQL 17.6)` and `Integração com OneDrive`?**
...
- **Why does `react` connect `DS bundle (componentes JSX)` to `Autorizados: actions e telas`, `Community 1922`, `Community 1925`, `Dependências apps/web`, `Webhooks de saída`, `UI kit nogmaOS`, `Avatar: Avatar.jsx`, `Tag: Tag.jsx`, `Alert: Alert.jsx`, `Checkbox: Checkbox.jsx`, `Select: Select.jsx`, `Button: Button.jsx`, `IconButton: IconButton.jsx`, `Badge: Badge.jsx`, `Card: Card.jsx`, `Dialog: Dialog.jsx`, `Progress: Progress.jsx`, `Tooltip: Tooltip.jsx`, `Input: Input.jsx`, `RadioGroup: RadioGroup.jsx`, `Switch: Switch.jsx`, `Textarea: Textarea.jsx`, `Tabs: Tabs.jsx`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `createClient()` connect `Fornecedores e planilha compartilhada` to `Documentos: telas e formulário`, `Autorizados: actions e telas`, `Community 1924`, `Community 261`, `Usuários: convite e papéis`, `reports: reports.ts`, `Community 1931`, `comandos: comandos.ts`, `Classificador Anthropic (visão)`, `Inbound WhatsApp e UAZAPI`, `Community 1935`, `Importar CSV de pagamentos`, `Community 1938`, `Community 1942`, `Community 1943`, `Community 1944`, `Auditoria: diff viewer`, `08 infra deploy ci: playwright.config.ts`, `Community 1952`, `Exportação CSV/PDF (rotas)`, `Community 1958`, `Community 1959`, `pagamentos filters: pagamentos-filters.tsx`, `painel: page.tsx`, `page: page.tsx`, `rate limit: actions.ts`, `IconButton: mobile-nav.tsx`, `log: log.ts`, `actions: actions.ts`, `layout: layout.tsx`, `command palette: route.ts`, `obra: obra.ts`, `pagamento: pagamento.ts`, `Community 1912`, `Community 1913`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Input()` connect `Autorizados: actions e telas` to `Documentos: telas e formulário`, `Webhooks de saída`, `layout: layout.tsx`, `pagamentos filters: pagamentos-filters.tsx`, `import pagamento: ImportarClient()`, `Community 1944`, `DS bundle (componentes JSX)`, `log: log.ts`?**
...
- **Should `Documentos: telas e formulário` be split into smaller, more focused modules?**
